...
Button docButton; ///\brief Кнопка открытия документации

Button PauseexitButton; ///\brief Кнопка выхода в паузе
Button PausesaveButton; ///\brief Кнопка сохранения в паузе
Button PauseloadButton; ///\brief Кнопка загрузки в паузе
Button PausecontinueButton; ///\brief Кнопка продолжения в паузе
Button PausesettingsButton; ///\brief Кнопка настроек в паузе
